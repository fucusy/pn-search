...
private:
	...
	// returns TRUE if player_to_evaluate is defending a thretening three - eg: ...XOXX....
	...
	// returns TRUE if player_to_evaluate is threateng with a three - eg: ...O.OO...
	static bool threat_3_att(std::array<figure, 11>& line, figure player_to_evaluate);

	// returns TRUE if player_to_evaluate is threateng with a four - eg: ...O.OOO...
